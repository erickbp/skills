...
Build the `Decision Ledger` before writing cards.

## Purpose

The ledger separates what is fixed from what is flexible so decomposition does not silently change product intent.
...
- move nice-to-have work into `Follow-up Tasks`
...
If the ledger is weak, the decomposition is weak. Revise it before final output.
